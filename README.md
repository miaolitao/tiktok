...
-- 增量
python DouYinCommand.py -C True -l https://v.douyin.com/i6k9j9fX/ -p D:\work\GitHub\python\tiktok\downloads --folderstyle False --postincrease True
...
-- 小乔 长按复制此条消息，打开抖音搜索，查看TA的更多作品。 https://v.douyin.com/i6w3p43R/
